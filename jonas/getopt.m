...
%
%   originally written by Jonas B. Zimmerman, edited slightly by John
%   Barrett to supress various errors/warnings
...
for n=1:2:length(varargin)
  ...
  if isempty(opts)
	...
	warning('GetOpt:UnknownOption','Unknown option "%s"',k);
      end
    elseif length(idx)>1
