...
stimulate(getPixels2,textureRect,NaN,[560 0 640 480],colour,zeros(size(colour)),60,'C:\John Barrett\JBWT0020\Stim 4.mat',false,false,false,getExtraParams);
% stimulate(getPixels2,textureRect,NaN,[560 0 640 480],colour,zeros(size(colour)),60,NaN,false,false,getExtraParams);
% stimulate(getPixels2,textureRect,[0 0 640 480],[560 0 640 480],colour,zeros(size(colour)),60,NaN,false,false,false,getExtraParams);