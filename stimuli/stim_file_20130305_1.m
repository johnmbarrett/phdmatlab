...
% stimulate(getPixels,textureRect,NaN,[560 0 640 480],colour,zeros(size(colour)),60,'C:\John Barrett\JBWT0016\Stim 2.mat',false,false,getExtraParams);
% stimulate(getPixels,textureRect,NaN,[560 0 640 480],colour,zeros(size(colour)),60,NaN,false,false,getExtraParams);
stimulate(getPixels,textureRect,[0 0 640 480],[560 0 640 480],colour,zeros(size(colour)),60,NaN,false,false,false,getExtraParams);