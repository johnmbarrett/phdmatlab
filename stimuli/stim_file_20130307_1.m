...
stimulate(getPixels2,textureRect,[],[530 0 640 480],colour,zeros(size(colour)),60,'C:\John Barrett\JBWT0020\Stim 3.mat',false,false,false,getExtraParams);
% stimulate(getPixels2,textureRect,[],[530 0 640 480],colour,zeros(size(colour)),60,NaN,false,false,false,getExtraParams);