...
saveFile = 'D:\John B\Electrophysiology\Wild-Type Stim\JBWT0051\Stim 1.mat';

% stimulus generation code
getPixels1 = cell(4,1);

getPixels1{1} = colourSequence(128,textureRect,pauseTime,pauseTime);
getPixels1{2} = colourSequence({255; 128; 0; 128},textureRect,repmat([flashTime; pauseTime],2,1),repeats*(flashTime+pauseTime)*2,true,1);
