...
getPixels{1} = colourSequence(128,textureRect,Inf,180);

for kk = 1:nTrials
    mask = colourSequence(128,textureRect,Inf,maskTime);
...
% !!! FILL IN SAVE FILE !!!
stimulate(getPixels,textureRect,[1920 0 1920+640 480],markerRect,255,0,60,'D:\John B\Electrophysiology\Wild-Type Stim\JBWT0050\Stim 2.mat',false,false,false,cell(size(getPixels)));
