...
getPixels{1} = colourSequence(128,[0 0 520 480],Inf,180);

for kk = 1:nTrials
    mask = colourSequence(128,[0 0 520 480],Inf,maskTime);
...
% !!! FILL IN SAVE FILE !!!
stimulate(getPixels,[0 0 520 480],[],[520 0 640 480],255,0,60,'D:\John B\Electrophys\JBWT0023\Stim 2.mat',false,false,false,cell(size(getPixels)));
