% params
X = 366; % screen co-ords
Y = 351; % screen co-ords
width = 800; % microns
...
saveFile = 'D:\John B\Electrophysiology\Wild-Type Stim\JBWT0030\Stim 1.mat';
...
disp((size(getPixels,1)*(whiteTime+blackTime))/(60*fps)+whiteNoiseTime);
